{
    ...
    "vars": {
        ...
        "CREDITS_REFERRAL_ENABLED": "{{CREDITS_REFERRAL_ENABLED}}",
        "CREDITS_REFERRAL_INVITER_AMOUNT": "{{CREDITS_REFERRAL_INVITER_AMOUNT}}",
        "CREDITS_REFERRAL_INVITEE_AMOUNT": "{{CREDITS_REFERRAL_INVITEE_AMOUNT}}",
