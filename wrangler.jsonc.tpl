{
    ...
    "vars": {
        ...
        "IMAGE_SEEDDREAM_API_KEY": "{{IMAGE_SEEDDREAM_API_KEY}}",
        "IMAGE_SEEDDREAM_MODEL": "{{IMAGE_SEEDDREAM_MODEL}}",
        "IMAGE_ALIYUN_BASE_URL": "{{IMAGE_ALIYUN_BASE_URL}}",
        "IMAGE_ALIYUN_API_KEY": "{{IMAGE_ALIYUN_API_KEY}}",
        ...
        "TTS_SEED_API_KEY": "{{TTS_SEED_API_KEY}}",
        "TTS_SEED_MODEL": "{{TTS_SEED_MODEL}}",
        "VIDEO_SEEDDANCE_BASE_URL": "{{VIDEO_SEEDDANCE_BASE_URL}}",
        "VIDEO_SEEDDANCE_API_KEY": "{{VIDEO_SEEDDANCE_API_KEY}}",
        ...
        "R2_ORIGIN_SIGNING_SECRET": "{{R2_ORIGIN_SIGNING_SECRET}}",
        "DO_NAMES": "{{DO_NAMES}}"
    }
}
