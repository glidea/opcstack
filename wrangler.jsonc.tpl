{
    ...
    "vars": {
        ...
        "CHAT_OPENAI_FALLBACK_API_KEY": "{{CHAT_OPENAI_FALLBACK_API_KEY}}",
        ...
        "IMAGE_GEMINI_FALLBACK_API_KEY": "{{IMAGE_GEMINI_FALLBACK_API_KEY}}",
        ...
        "IMAGE_OPENAI_FALLBACK_API_KEY": "{{IMAGE_OPENAI_FALLBACK_API_KEY}}",
        ...
        "IMAGE_SEEDDREAM_FALLBACK_API_KEY": "{{IMAGE_SEEDDREAM_FALLBACK_API_KEY}}",
        ...
        "IMAGE_ALIYUN_FALLBACK_API_KEY": "{{IMAGE_ALIYUN_FALLBACK_API_KEY}}",
        ...
        "TTS_GEMINI_FALLBACK_API_KEY": "{{TTS_GEMINI_FALLBACK_API_KEY}}",
        ...
        "TTS_SEED_FALLBACK_API_KEY": "{{TTS_SEED_FALLBACK_API_KEY}}",
        "TTS_SEED_MODEL": "{{TTS_SEED_MODEL}}",
        "REALTIME_DOUBAO_BASE_URL": "{{REALTIME_DOUBAO_BASE_URL}}",
        "REALTIME_DOUBAO_API_KEY": "{{REALTIME_DOUBAO_API_KEY}}",
        "REALTIME_DOUBAO_FALLBACK_BASE_URL": "{{REALTIME_DOUBAO_FALLBACK_BASE_URL}}",
        "REALTIME_DOUBAO_FALLBACK_API_KEY": "{{REALTIME_DOUBAO_FALLBACK_API_KEY}}",
        ...
        "VIDEO_SEEDDANCE_FALLBACK_API_KEY": "{{VIDEO_SEEDDANCE_FALLBACK_API_KEY}}",
