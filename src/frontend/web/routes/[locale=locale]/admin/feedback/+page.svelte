<script lang="ts">
	...
	function updateUrl(input: ListFeedbacksRequest, detailKey: string = ''): void {
		const search: string = createAdminPageSearch(createFeedbackSearchParams(input), detailKey)
