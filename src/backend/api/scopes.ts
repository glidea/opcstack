...
export const PROTECTED_JSON_ROUTES: ProtectedJsonRoute[] = [
	...
	{ method: 'POST', path: '/api/get_affiliate_summary', scope: 'affiliate:read', access: 'user' },
	{ method: 'POST', path: '/api/bind_affiliate', scope: 'affiliate:write', access: 'user' },
	...
	{ method: 'POST', path: '/api/admin/get_dashboard', scope: 'admin:dashboard:read', access: 'admin' },
	...
	{ method: 'POST', path: '/api/admin/list_credit_transactions', scope: 'admin:credits:read', access: 'admin' },
	{ method: 'POST', path: '/api/admin/list_affiliate_referrals', scope: 'admin:affiliate:read', access: 'admin' },
