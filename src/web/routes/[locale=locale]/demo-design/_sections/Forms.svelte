<script lang="ts">
	...
	import * as InputOTP from "$web/ui/input-otp";
	import * as InputGroup from "$web/ui/input-group";
	import * as Field from "$web/ui/field";
...
>
	...
	<Block title={$_("designSystem.s3.b.otpCustom")} description="components/OtpInput.svelte." span={2}>
	...
	<div class="col-span-12 rounded-[var(--radius-lg)] border border-dashed border-border bg-card p-6">
		...
		<p class="text-caption mt-2 text-muted-foreground">
			<code class="font-mono">$web/ui/form/*</code> wraps
