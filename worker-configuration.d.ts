/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config .wrangler/wrangler.types.jsonc --strict-vars false` (hash: 348176ebb277eada6a539beecb67abb8)
// Runtime types generated with workerd@1.20260401.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		META_DB: D1Database;
		TENANT_DB_APAC_0000: D1Database;
		SEND_EMAIL: SendEmail;
		Q_IMAGE_GENERATE: Queue;
		Q_TTS_GENERATE: Queue;
		Q_VIDEO_GENERATE: Queue;
		ASSETS: Fetcher;
		...
		APP_BASE_URL: string;
		APP_DOMAIN: string;
		APP_CN_DOMAIN: string;
		APP_CN_CNAME_TARGET: string;
		DOCS_ENABLED: string;
		EXTENSION_HOST_PERMISSIONS: string;
		BETA_CODE_ENABLED: string;
		TURNSTILE_ENABLED: string;
		TURNSTILE_SITE_KEY: string;
		GOOGLE_AUTH_ENABLED: string;
		GOOGLE_CLIENT_ID: string;
		GITHUB_AUTH_ENABLED: string;
		GITHUB_CLIENT_ID: string;
		LINUXDO_AUTH_ENABLED: string;
		LINUXDO_CLIENT_ID: string;
		EMAIL_PROVIDER: string;
		EMAIL_SIGNUP_ENABLED: string;
		EMAIL_REQUIRE_VERIFICATION: string;
		EMAIL_USER_ACTION_COOLDOWN_SECONDS: string;
		EMAIL_SIGNUP_DOMAIN_ALLOWLIST: string;
		CREDITS_SIGNUP_ENABLED: string;
		CREDITS_SIGNUP_AMOUNT: string;
		CREDITS_DAILY_CHECKIN_ENABLED: string;
		CREDITS_DAILY_CHECKIN_AMOUNT: string;
		AFF_ENABLED: string;
		AFF_INVITER_CREDIT_AMOUNT: string;
		AFF_INVITEE_CREDIT_AMOUNT: string;
		CREDITS_HISTORY_RETENTION_DAYS: string;
		...
		AI_ROUTING_ERROR_WEIGHT: string;
		AI_ROUTING_LATENCY_WEIGHT: string;
		AI_ROUTING_PRICE_WEIGHT: string;
		AI_TASK_RETENTION_DAYS: string;
		CHAT_OPENAI_BASE_URL: string;
		CHAT_OPENAI_MODEL: string;
		IMAGE_GEMINI_BASE_URL: string;
		IMAGE_GEMINI_MODEL: string;
		IMAGE_OPENAI_BASE_URL: string;
		IMAGE_OPENAI_MODEL: string;
		IMAGE_SEEDDREAM_BASE_URL: string;
		IMAGE_SEEDDREAM_MODEL: string;
		IMAGE_ALIYUN_BASE_URL: string;
		IMAGE_ALIYUN_MODEL: string;
		TTS_GEMINI_BASE_URL: string;
		TTS_GEMINI_MODEL: string;
		TTS_SEED_BASE_URL: string;
		TTS_SEED_MODEL: string;
		REALTIME_DOUBAO_BASE_URL: string;
		REALTIME_DOUBAO_MODEL: string;
		VIDEO_SEEDDANCE_BASE_URL: string;
		VIDEO_SEEDDANCE_MODEL: string;
		IMAGE_GEMINI_OFFICIAL_BASE_URL: string;
		IMAGE_GEMINI_OFFICIAL_MODELS: string;
		IMAGE_GEMINI_OFFICIAL_PRICE_MULTIPLIER: string;
		IMAGE_OPENAI_OFFICIAL_BASE_URL: string;
		IMAGE_OPENAI_OFFICIAL_MODELS: string;
		IMAGE_OPENAI_OFFICIAL_PRICE_MULTIPLIER: string;
		IMAGE_SEEDDREAM_OFFICIAL_BASE_URL: string;
		IMAGE_SEEDDREAM_OFFICIAL_MODELS: string;
		IMAGE_SEEDDREAM_OFFICIAL_PRICE_MULTIPLIER: string;
		IMAGE_ALIYUN_OFFICIAL_BASE_URL: string;
		IMAGE_ALIYUN_OFFICIAL_MODELS: string;
		IMAGE_ALIYUN_OFFICIAL_PRICE_MULTIPLIER: string;
		TTS_GEMINI_OFFICIAL_BASE_URL: string;
		TTS_GEMINI_OFFICIAL_MODELS: string;
		TTS_GEMINI_OFFICIAL_PRICE_MULTIPLIER: string;
		TTS_SEED_OFFICIAL_BASE_URL: string;
		TTS_SEED_OFFICIAL_MODELS: string;
		TTS_SEED_OFFICIAL_PRICE_MULTIPLIER: string;
		VIDEO_SEEDDANCE_OFFICIAL_BASE_URL: string;
		VIDEO_SEEDDANCE_OFFICIAL_MODELS: string;
		VIDEO_SEEDDANCE_OFFICIAL_PRICE_MULTIPLIER: string;
		R2_USER_UPLOAD_ALLOWED_CONTENT_TYPES: string;
		R2_USER_UPLOAD_MAX_BYTES: string;
		R2_TMP_LIFECYCLE_RULES: string;
		DO_NAMES: string;
		R2_ENABLED: string;
		...
		IMAGE_SEEDDREAM_API_KEY: string;
		IMAGE_ALIYUN_API_KEY: string;
		TTS_GEMINI_API_KEY: string;
		TTS_SEED_API_KEY: string;
		REALTIME_DOUBAO_API_KEY: string;
		VIDEO_SEEDDANCE_API_KEY: string;
		IMAGE_GEMINI_OFFICIAL_API_KEY: string;
		IMAGE_OPENAI_OFFICIAL_API_KEY: string;
		IMAGE_SEEDDREAM_OFFICIAL_API_KEY: string;
		IMAGE_ALIYUN_OFFICIAL_API_KEY: string;
		TTS_GEMINI_OFFICIAL_API_KEY: string;
		TTS_SEED_OFFICIAL_API_KEY: string;
		VIDEO_SEEDDANCE_OFFICIAL_API_KEY: string;
		R2_ORIGIN_SIGNING_SECRET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DESIGN_SYSTEM" | "APP_NAME" | "APP_VERSION" | "SYSTEM_EMAIL" | "APP_BASE_URL" | "APP_DOMAIN" | "APP_CN_DOMAIN" | "APP_CN_CNAME_TARGET" | "DOCS_ENABLED" | "EXTENSION_HOST_PERMISSIONS" | "BETA_CODE_ENABLED" | "TURNSTILE_ENABLED" | "TURNSTILE_SITE_KEY" | "GOOGLE_AUTH_ENABLED" | "GOOGLE_CLIENT_ID" | "GITHUB_AUTH_ENABLED" | "GITHUB_CLIENT_ID" | "LINUXDO_AUTH_ENABLED" | "LINUXDO_CLIENT_ID" | "EMAIL_PROVIDER" | "EMAIL_SIGNUP_ENABLED" | "EMAIL_REQUIRE_VERIFICATION" | "EMAIL_USER_ACTION_COOLDOWN_SECONDS" | "EMAIL_SIGNUP_DOMAIN_ALLOWLIST" | "CREDITS_SIGNUP_ENABLED" | "CREDITS_SIGNUP_AMOUNT" | "CREDITS_DAILY_CHECKIN_ENABLED" | "CREDITS_DAILY_CHECKIN_AMOUNT" | "AFF_ENABLED" | "AFF_INVITER_CREDIT_AMOUNT" | "AFF_INVITEE_CREDIT_AMOUNT" | "CREDITS_HISTORY_RETENTION_DAYS" | "PAYMENT_ENABLED" | "PAYMENT_PROVIDER" | "PAYMENT_PROVIDER_COUNTRY_OVERRIDES" | "PAYMENT_PRODUCTS" | "PAYMENT_DODO_TEST_MODE" | "PAYMENT_CREEM_TEST_MODE" | "AI_ROUTING_ERROR_WEIGHT" | "AI_ROUTING_LATENCY_WEIGHT" | "AI_ROUTING_PRICE_WEIGHT" | "AI_TASK_RETENTION_DAYS" | "CHAT_OPENAI_BASE_URL" | "CHAT_OPENAI_MODEL" | "IMAGE_GEMINI_BASE_URL" | "IMAGE_GEMINI_MODEL" | "IMAGE_OPENAI_BASE_URL" | "IMAGE_OPENAI_MODEL" | "IMAGE_SEEDDREAM_BASE_URL" | "IMAGE_SEEDDREAM_MODEL" | "IMAGE_ALIYUN_BASE_URL" | "IMAGE_ALIYUN_MODEL" | "TTS_GEMINI_BASE_URL" | "TTS_GEMINI_MODEL" | "TTS_SEED_BASE_URL" | "TTS_SEED_MODEL" | "REALTIME_DOUBAO_BASE_URL" | "REALTIME_DOUBAO_MODEL" | "VIDEO_SEEDDANCE_BASE_URL" | "VIDEO_SEEDDANCE_MODEL" | "IMAGE_GEMINI_OFFICIAL_BASE_URL" | "IMAGE_GEMINI_OFFICIAL_MODELS" | "IMAGE_GEMINI_OFFICIAL_PRICE_MULTIPLIER" | "IMAGE_OPENAI_OFFICIAL_BASE_URL" | "IMAGE_OPENAI_OFFICIAL_MODELS" | "IMAGE_OPENAI_OFFICIAL_PRICE_MULTIPLIER" | "IMAGE_SEEDDREAM_OFFICIAL_BASE_URL" | "IMAGE_SEEDDREAM_OFFICIAL_MODELS" | "IMAGE_SEEDDREAM_OFFICIAL_PRICE_MULTIPLIER" | "IMAGE_ALIYUN_OFFICIAL_BASE_URL" | "IMAGE_ALIYUN_OFFICIAL_MODELS" | "IMAGE_ALIYUN_OFFICIAL_PRICE_MULTIPLIER" | "TTS_GEMINI_OFFICIAL_BASE_URL" | "TTS_GEMINI_OFFICIAL_MODELS" | "TTS_GEMINI_OFFICIAL_PRICE_MULTIPLIER" | "TTS_SEED_OFFICIAL_BASE_URL" | "TTS_SEED_OFFICIAL_MODELS" | "TTS_SEED_OFFICIAL_PRICE_MULTIPLIER" | "VIDEO_SEEDDANCE_OFFICIAL_BASE_URL" | "VIDEO_SEEDDANCE_OFFICIAL_MODELS" | "VIDEO_SEEDDANCE_OFFICIAL_PRICE_MULTIPLIER" | "R2_USER_UPLOAD_ALLOWED_CONTENT_TYPES" | "R2_USER_UPLOAD_MAX_BYTES" | "R2_TMP_LIFECYCLE_RULES" | "DO_NAMES" | "R2_ENABLED" | "R2_ACCOUNT_ID" | "BETTER_AUTH_SECRET" | "CONFIG_ENCRYPTION_KEY" | "SUPER_ADMIN_PASSWORD" | "ADMIN_API_TOKEN" | "TURNSTILE_SECRET_KEY" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_SECRET" | "LINUXDO_CLIENT_SECRET" | "EMAIL_RESEND_API_KEY" | "PAYMENT_DODO_API_KEY" | "PAYMENT_DODO_WEBHOOK_SECRET" | "PAYMENT_CREEM_API_KEY" | "PAYMENT_CREEM_WEBHOOK_SECRET" | "CHAT_OPENAI_API_KEY" | "IMAGE_GEMINI_API_KEY" | "IMAGE_OPENAI_API_KEY" | "IMAGE_SEEDDREAM_API_KEY" | "IMAGE_ALIYUN_API_KEY" | "TTS_GEMINI_API_KEY" | "TTS_SEED_API_KEY" | "REALTIME_DOUBAO_API_KEY" | "VIDEO_SEEDDANCE_API_KEY" | "IMAGE_GEMINI_OFFICIAL_API_KEY" | "IMAGE_OPENAI_OFFICIAL_API_KEY" | "IMAGE_SEEDDREAM_OFFICIAL_API_KEY" | "IMAGE_ALIYUN_OFFICIAL_API_KEY" | "TTS_GEMINI_OFFICIAL_API_KEY" | "TTS_SEED_OFFICIAL_API_KEY" | "VIDEO_SEEDDANCE_OFFICIAL_API_KEY" | "R2_ORIGIN_SIGNING_SECRET">> {}
}
